...
@Component({
  ...
  templateUrl: './appointment-report.page.html',
  styleUrls: ['./appointment-report.page.scss'],
})
export class AppointmentReportPage implements OnInit {
  ...
  ngOnInit() {
    ...
    ionViewDidEnter() {
      var user_id = localStorage.getItem("user_id");
        if (user_id === null) {
          ...
          var formData: any = new FormData();
          formData.append("key", "get_all_clinician_name_id");
    ...
    selectedAppointment(){
      ...
      var formData: any = new FormData();
      formData.append("key", "filter_data_doctor_clincian_date");
      formData.append("clinic_id", this.clinic_id);
    ...
    async exportToExcel(data, filename="appointment_report") {
    ...
    console.log(items);
     ...
     // pdfmake.createPdf(dd).open();
      ...
      downloadPdf() {
          ...
          //   this.file.writeFile(this.file.dataDirectory, 'appointment_report.pdf', blob, { replace: true }).then(fileEntry => {
          //     // Open the PDf with the correct OS tools
          //     this.fileOpener.open(this.file.dataDirectory + 'appointment_report.pdf', 'application/pdf');
          //   })
          // });
