...
@Component({
  selector: 'app-upload-doctor-signature',
  templateUrl: './upload-doctor-signature.page.html',
  styleUrls: ['./upload-doctor-signature.page.scss'],
})
export class UploadDoctorSignaturePage implements OnInit {
  doctor_id: any = {};
  user_id: any = {};
  profile: any = {};
  img1 : any = [];
  ...
  role: string;
  constructor(public route : ActivatedRoute,public router : Router,public http : HttpClient, public navCtrl: NavController,  public toastController: ToastController) { }
  ...
  ngOnInit() {
    ...
    this.doctor_id =this.route.snapshot.params['id'];
      if (user_id === null) {
        ...
        let post_id = JSON.stringify({'id': this.doctor_id});
