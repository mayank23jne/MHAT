...
export class EditNotePage implements OnInit {
  ...
  constructor(
    ...
    ngOnInit() {
      var user_id = localStorage.getItem("user_id");
        if (this.userID === null) {
          ...
          formData.append("id", this.noteID);
          this.http.post(this.baseURI+'manage-note.php', formData).subscribe((data : any) =>{
            this.notes = data;
            var formData1: any = new FormData();
            formData1.append("key", "get_patient_name_by_id");
            formData1.append("id", this.notes.patient_id);
    ...
    presentActionSheet() {
      ...
      formData.append("description", this.notes.description);
